...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl text-center md:text-start mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-2xl font-bold md:text-4xl mb-2 text-orange-500 dark:text-white max-w-4xl">
          Who We Are ??
        </h2>
